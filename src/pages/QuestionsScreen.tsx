...
export default function QuestionsScreen() {
  ...
  const handleEdit = (id: string) => {
    // Placeholder — route connected in PR 3
    void id
  }

  const handleDelete = (_id: string) => {
    // Placeholder — wired in PR 3
  }
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 flex flex-col sm:flex-row gap-3">
        ...
        {(levelFilter || categoryFilter) && (
          <button
            ...
            className="px-3 py-2 text-sm text-gray-600 hover:text-gray-800 font-medium whitespace-nowrap"
          >
