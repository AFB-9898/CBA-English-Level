-- Contract tests for migration 012. Run after `supabase db reset` with psql.
...
INSERT INTO public.exam (id, student_id, completed_at, score, level_id, status) VALUES
  ...
  ('00000000-0000-0000-0000-000000000130', '00000000-0000-0000-0000-000000000129', CURRENT_DATE, 88, (SELECT id FROM public.level WHERE code = 'B1' AND version = 1), 'completed');
